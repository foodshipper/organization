...
\section{Frist Startup and Offline Challenge}
\frame{\frametitle{Login}
	\begin{itemize}
		\item Login and Jiss
	\end{itemize}
	\begin{figure}
...
\frame{\frametitle{Offline Challenge}
	\begin{itemize}
		\item Login and Location get Persisted
	\end{itemize}
}
...
\frame{\frametitle{Notification}
	\begin{itemize}
		\item Do you want to eat ? 
	\end{itemize}
	\begin{figure}
		\begin{center}
			\includegraphics[width=0.25\textwidth,height=\textheight,keepaspectratio]{../screenshots/overview.png}
